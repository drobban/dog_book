defmodule DogBookWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DogBookWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DogBookWeb.Gettext, "errors", msg, opts)
    end
  end
